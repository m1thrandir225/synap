...
from models.user import CreateUserDTO, UpdateUserDTO, UpdateUserPasswordDTO
...
class UserService:
    ...
    def create_user(self, user_data: CreateUserDTO) -> dict:
        ...
        user_data_dict["created_at"] = datetime.now(datetime.timezone.utc)  # Add created_at
    ...
    def update_password(self, user_id: str, password_data: UpdateUserPasswordDTO) -> dict:
        user = self.user_repo.get_by_id(user_id)
